...
public class UdpClient {
	...
	public static void main(String[] args) {
		try(Socket socket = new Socket("codebank.xyz", 38005)) {
			...
			//Print Server response, 0xCAFEBABE (good response)
	...
	/**
	 * Helper Method - Set Destination Address in packet
	 */
	...
	/**
	 * Helper Method - Print response from Server in Hex
	 */
	...
	/**
	 * Helper Method - Create IPv4 Packet Header
	 */
	public static byte[] createIPv4(Socket socket, int dataLength, byte[] data) {
		...
		//Values at packet[4] and packet[5] are initialized to 0
	...
	/**
	 * Helper Method - Print binary output of IPv4 packet headers
	 * */
